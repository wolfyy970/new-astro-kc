...
- **Marginalia discovery:** below the wide tier, a static editor's note bound into the top of the sheet explains the two highlighter inks with yellow and green specimens. At ≥1420px the note yields to the margin's own cold-start introduction, which still runs the full staged ladder.

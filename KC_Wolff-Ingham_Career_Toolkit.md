...
**Phone:** 404.725.0417  
**LinkedIn:** linkedin.com/in/kcwolff  
**Location:** Atlanta, GA
...
- **Positioning strategy** — How to frame experience for different role types

**NOT intended to be sent to recruiters or employers directly.**
...
Depending on the target role, I can position as:

1. **Design & Product Executive** — For VP/Head of Design roles. Emphasizes UX leadership, team building, design systems, measurable business outcomes.

2. **Innovation & Digital Product Executive** — For Head of Incubator, Head of Innovation, CDO roles. Emphasizes R&D leadership, emerging technology adoption, strategic foresight, venture incubation.

**Core differentiator across both:** Rare combination of technical depth (BS Computer Science, two patents), human-centered design expertise (MS HCI), and business strategy (Executive MBA, Brown/IE).
...
- **Origin story:** Technical AI/ML roots dating back to undergraduate work

**Narrative value:** Both projects demonstrate early foresight — predicting internet importance before the web went mainstream, and working on neural network fundamentals decades before the current AI wave. This is not hindsight; this is documented, timestamped foresight.
...
- Design had no independent voice — business/product dictated solutions
...
**Budget:** ~$6M annually (headcount + software/tools)

**Key Responsibilities:**

1. **Unified Commerce Platform Redesign**
   - Leading research-driven redesign of $8B ecommerce platform
   - **Revenue impact: $30.2 million** (homepage redesign, fiscal year 2025)
   - Measurement: Rigorous A/B testing and cohort analysis with full attribution methodology
   - Have all receipts and documentation on measurement approach
   - For resumes, use "$30M+" as the rounded figure

   **The "Ways of Finding" Strategy:**
   - Two years of research led to key insight: B2B parts lookup ≠ traditional ecommerce
   - Service advisors often have the part in hand; need to identify it, not "shop" for it
   - Introduced "ways of finding" concept — multiple paths to the same part:
     - Category search
     - Part number lookup
     - Job type (what job are you doing?)
     - Legacy PDF catalogs
     - Future: diagrams/visual lookup
   - This research-driven strategy was the foundation of the $30M impact

2. **Internal Startup Support**
   - Leading design for an internal startup within GPC
   - **Highly confidential / stealth** — limited public discussion
   - Can say: Utilizes AI and machine learning, aimed at revolutionizing repair shop management
   - This venture originated from the strategic foresight work I conducted during my consulting engagement on the future of auto care
   - Important connection: Consulting work → GPC hired me → Now executing that vision
   - **Role:** Design Manager leads day-to-day; KC is hands-on + advisory, increasingly hands-on over time
   - **Agentic UI:** Designing user interfaces for agentic AI systems — the 30-year through-line from 1993 back-propagation work continues

3. **Design System ("Bolt")**
   - Built from scratch — did not inherit a design system
   - Design engineering team (front-end engineers) owns technical implementation
   - Adopted across North America, Europe, and Asia Pacific
   - Reduced front-end development time by ~25%

4. **AI Design Tool Adoption**
   - Early adopter of AI design tools: v0, Cursor, Claude Code
   - Integrated into enterprise workflows
   - Purpose: Accelerate team exploration capacity and prototyping speed

5. **Organizational Positioning**
   - Established design and research as strategic function
   - Direct CIO reporting relationship
...
- Resolution: Earned trust through results over time; $30M impact validated the approach
...
- **GPC Strategic Foresight (10 months)**
  ...
  - Outcome: Work directly informed company's digital transformation roadmap
  - Result: Recruited as Head of UX Design and Research to execute the vision
...
- Scaled to 30-person team during merger
- Remit: Transform nascent design capability into enterprise-grade function
- Established evidence-based design methodology (same philosophy as GPC)

**Budget:** ~$7M annually (headcount + tools)
...
1. **Accelerator Studio (NOT "Innovation Studio")**
   ...
   - **Two major additions I introduced:**
     1. Customer journeys
     2. Strategic foresight
   - This repositioning led to partnership with Corporate Strategy

2. **Strategic Foresight & Merger Influence**
   ...
   **Credit/Politics:**
   ...
   - But the impetus, methodology, and design of the exercise was KC's — can defend this in detail

3. **Blockchain/DeFi Exploration**
   - Explored blockchain and decentralized finance as emerging technologies
   - Part of Accelerator Studio work
   - Context: Understanding how these technologies might impact banking business models

4. **Service Design Practice**
   - Founded the Service Design practice (this one I DID found)
   - Purpose: Drive journey-based transformation across products and channels

5. **Product Rebuilds**
   - Rebuilt Commercial Banking applications for merged entity
   - Rebuilt Small Business applications
   - Rebuilt Investment Banking applications

6. **SAFe Integration**
   - Integrated voice of the customer through design and research into Scaled Agile Framework
   - NOT "innovation methodologies" — specifically design and research / voice of customer
...
- Retained through merger with bonus to ensure design capability continuity
- Left on good terms after merger integration completed
- Transitioned directly into consulting (no gap) — had existing relationships from Sparks Grove era
- Had an engineering partner for consulting business
...
1. **Business Development**
   - Won $4.7M+ in new business over 2.5 years
   - Led wins of $3M in client projects during first year alone

2. **Agency Transformation**
   - Led transformation from traditional agency model to agile software development and lean product management

3. **Positioning Shift**
   - Shifted agency positioning to "Human Experience Design" (HxD)
...
- Universal Studios
- T-Mobile
- The Home Depot — Helped reboot their product organization to lean product development
...
- Timing issue more than execution issue

**Important for positioning:** This is a genuine venture incubation story — concept to 1M users in 8 months, then sunset due to strategic pivot by parent company.
...
**Properties Served:** CNN, Cartoon Network, TBS, TNT

**Team:** 5 direct reports + offshore contractors

**Key Projects:**

1. **CNN Magic Wall**
   - Co-designed (not sole designer) large-format multi-touch interface
   - Pioneered data-driven storytelling for election coverage
   - Introduced massive multi-touch screen paradigm

2. **Automatic Content Recognition (ACR) Technology**
   - Developed platform for in-house ACR solution
   - Sync-to-TV technology for TBS & TNT
   - Two patents granted:
     - US9043821B2 — Automatic content recognition systems (Filed 2011, Granted 2015)
     - US9167276B2 — Audience engagement technologies (Filed 2011, Granted 2015)

3. **Emmy Award Contribution**
   - Emmy Award (2011): Outstanding Creative Achievement in Interactive Media
   - Project: "Conan O'Brien Presents: Team Coco" App
   - My contribution: The ACR technology that powered the app
   - This was a TEAM award — I contributed the technology, did not lead the whole project
   - Framing: "Contributed ACR technology for Emmy Award-winning app" NOT "Won Emmy Award"

4. **CNN Push Notification Platform ("Notify")**
   - Designed and built scalable SaaS push notification platform
   - For CNN breaking news
   - Reached millions of devices
   - ROI achieved within 4 months

5. **CNN World Cup Twitter Application**
...
1. **Mobile Augmented Reality (Experimental)**
   - Pioneered first mobile AR applications in U.S.
   - Partnered with Georgia Tech (academic research partnership)
   - Augmented reality for mobile devices, pre-iPhone
   - **NBA Project:** Billboard advertising network — AR interaction with advertising
   - **Cartoon Network Project:** Gaming
   - Device: Nokia N90, before iPhone and real smartphone lift-off
   - **Key foresight:** Predicted that mobile phone processing power trajectory and GPU support would ensure AR happened on mobile first — which proved correct
   - Important: This was pioneering experimental work demonstrating technology foresight

2. **Cloud Gaming (GameTap)**
   - Prototyped streaming games using instant-on video technology
   - Early cloud gaming exploration

3. **Virtual Economies (PlayStation Home)**
   - Legitimized virtual item sales from virtual worlds as an alternate incremental revenue stream
   - Properties: Cartoon Network & Adult Swim on Sony PlayStation Home
...
1. **First Interactive TV Multiplayer Game Service**
   - Pioneered interactive television gaming

2. **Realtime Fantasy Football**
   - BAFTA Interactive Entertainment Awards Nomination (2000) — Sports category
   - "Armchair Manager – Football"

3. **Challenge TV**
   - First fully interactive network on Sky
...
**Note:** Applied for four patents; two were granted.
...
- Described concepts now called "spatial computing" (Apple Vision Pro, Meta Quest)
- Predicted virtual communities and their cultural impact
- Demonstrates: Pattern of technology foresight dating back 30+ years
- **The 30-year through-line:** Started with neural networks in 1993 → Now designing agentic user interfaces at GPC. This isn't a late pivot to AI; it's a continuation.
...
- Explored blockchain/DeFi as part of foresight work
- Work led to Corporate Strategy partnership
- Delivered C-suite presentations that shaped $66B merger strategy
- CEO said work was "instrumental"
...
- Partnered with IDEO
- Product was good, Turner's TV content wasn't strong enough
- Sunset when Turner exited health vertical
...
- NBA project: Billboard advertising network — AR interaction with advertising
- Cartoon Network project: Gaming
- 2005-2008, Nokia N90, pre-iPhone
- Key insight: Predicted mobile processing power and GPU support trajectory would ensure AR happened on mobile first — which proved correct
...
- Also: CNN Magic Wall, push notification platform

---

## THINGS NOT TO CLAIM

1. **Four patents** — Only two were granted
2. **"Won" Emmy Award** — Contributed technology to team award
3. **Founded Innovation Studio at Truist** — Rebooted/re-pivoted existing Accelerator Studio
4. **30-person team at Two Way Media** — Was approximately 20 people
5. **$80M or $40M revenue at GPC** — Confirmed figure is $30.2M (homepage redesign 2025); use "$30M+" on resumes
6. **"Led" the Team Coco project** — Contributed the ACR technology
7. **"Innovation methodologies" into SAFe** — Was voice of customer through design/research
8. **"Living in the future" for Accelerator Studio** — Correct framing is "customer journeys"

---

## TALENT DEVELOPMENT

- **Andy Vitale**: Hired to my team at SunTrust → Recruited away to become Head of Design at Rocket Mortgage
- This is evidence of developing leaders who get hired into senior roles at major companies

---

## GAPS TO ACKNOWLEDGE

1. **No direct P&L ownership** — Have influenced revenue, not owned a P&L
2. **No Insurtech experience** — Banking is adjacent but not insurance
3. **Limited public thought leadership** — "Silent doer" profile
4. **Most recent pure innovation role was 2014** — upwave.com; since then in design leadership with innovation components
...
## AGE / MARKET POSITIONING CONCERNS

- Aware of potential "aging out" dynamic in hiring
- Seeing it reflected in reduced interview volume
- **Counter-strategy:** Emphasize currency and forward-looking work
  - AI tool adoption (v0, Cursor, Claude Code)
  - Internal AI/ML startup
  - Recent measurable impact ($30M+ in 2025)
  - Not coasting on past wins
...
- November 2025: Created comprehensive version incorporating all clarifications
- December 2025: Major expansion during recruiter interview session
- January 2026: Updated with agentic UI details, strengthened origin story connection to current work
- January 2026: Reconstructed after accidental deletion
